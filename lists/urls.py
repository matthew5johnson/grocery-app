...
urlpatterns = [
    ...
    url(r'^new$', views.new_list, name='new_list'),   # ^lists/new$
    url(r'^(\d+)/$', views.view_list, name='view_list'),  # ^lists/(\d+)/$ # lists/the-only-list-in-the-world/$
    url(r'^(\d+)/add_item$', views.add_item, name='add_item'),  # ^lists/(\d+)/add_item$
]
